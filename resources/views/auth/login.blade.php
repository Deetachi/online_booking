...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="{{ asset('backend/images/logo_tcell.png') }}">

    <title>Online Booking Log in </title>
...
<body class="hold-transition theme-info bg-gradient-info">
			...
			<div class="col-12">
				<div class="row justify-content-center no-gutters">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
						<img src="{{ asset('backend/images/logo_tcell.png')}}" alt="" class="w-100 h-70">
                        &nbsp; &nbsp; <h3><b>Online Booking System</b></h3>
					 </div>
